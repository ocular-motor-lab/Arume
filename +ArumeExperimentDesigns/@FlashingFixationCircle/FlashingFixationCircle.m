classdef FlashingFixationCircle < ArumeExperimentDesigns.EyeTracking
        ...
        function [trialResult, thisTrialData] = runTrial(this, thisTrialData)
            try
                ...
                while frameCount < totalTrialFrames
                    ...
                    if stimOn
                        Screen('FrameOval', graph.window, circleColor, circleRect, lineThickness);
                        Screen('FillOval', graph.window, circleColor, dotRect);
                    end
