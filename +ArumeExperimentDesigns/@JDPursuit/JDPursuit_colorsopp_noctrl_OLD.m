classdef JDPursuit < ArumeExperimentDesigns.EyeTracking
    ...
    properties
        ...
        stimRect_size =  [0 0 45 120]; % [0 0 45 112]; %pixels
        fix_size = 20; %pixels
    ...
    methods ( Access = protected )
        ...
        function dlg = GetOptionsDialog( this, importing )
            ...
            dlg.LRoffset = {202 '* (100 if grow, 202 if shrink)' [0 500] };
        ...
        function trialTable = SetUpTrialTable(this)
            ...
            this.ExperimentOptions.Correct_Speed_TEST_pix = round(this.ExperimentOptions.Correct_Speed_TEST_deg*ppd_W);
            this.ExperimentOptions.Rate_lag_or_advance_pix =  round(this.ExperimentOptions.Rate_lag_or_advance_deg*ppd_W);
            this.ExperimentOptions.SpeedStep_pix = round(this.ExperimentOptions.SpeedStep_deg*ppd_W);
                ...
                while secondsRemaining > 0
                   ...
                   secondsRemaining    = this.ExperimentOptions.TrialDuration - secondsElapsed;
                    ...
                    if ( secondsElapsed < this.stimOffFixate_seconds)
                        ...
                        if thisTrialData.control_Fix_noMove == 0
        ...
        %%%
                    ...
                    if ( secondsElapsed > (this.stimOffFixate_seconds+ this.stimOffPursue_seconds + this.stimOnPursue_seconds + this.stimFadeOut_seconds) )
