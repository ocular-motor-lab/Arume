classdef CalibrationStereo < ArumeExperimentDesigns.EyeTracking
    ...
    properties
        fixRad = 20;
        fixColor = [255 0 0];
        targetPositions =[]; % TODO SOMEHOW ADD THIS IN BC ITS USED LATER
    end
    ...
    methods ( Access = protected )
        ...
        function [trialResult, thisTrialData] = runTrial( this, thisTrialData )
            try
                ...
                ok=cell2mat(thisTrialData.TargetPosition);
                targetHPix = this.Graph.pxWidth/(this.ExperimentOptions.DisplayOptions.ScreenWidth/2) * this.ExperimentOptions.DisplayOptions.ScreenDistance * tand(ok(1)); % divide screen width by 2 bc screenwidth is the whole monitor whereas pixWidth is just the screen window (which is half in our stereoMode case)
