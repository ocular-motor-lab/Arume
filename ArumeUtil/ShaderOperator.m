classdef ShaderOperator  < handle
    ...
    methods
        ...
        function init2dConvGaussPeriphShader(this, defaults, blurmethod)
        ...
        function init2dConvGaussFovShader(this, defaults, blurmethod)
            ...
            if blurmethod == 1
                this.shaderHandleConv2 = LoadGLSLProgramFromFiles(which('Conv2dMattAntiCircle.frag.txt'), 1);
            else
                this.shaderHandleConv2 = LoadGLSLProgramFromFiles(which('Conv2dMatt.frag.txt'), 1);
            end
